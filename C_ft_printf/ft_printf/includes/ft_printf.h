...
/*   Updated: 2021/01/27 18:47:08 by tnagoshi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				configure_status(va_list ap, char *format,
														t_status *status);
void				set_width_and_accuracy(va_list ap,
											char *format, t_status *status);
